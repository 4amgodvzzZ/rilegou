<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-date-picker v-model="listQuery.date"  align="right" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" class="filter-item" style="width: 200px;" placeholder="选择日期" ></el-date-picker>
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="订单代理" prop="regionName"/>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['订单ID', '订单编号', '用户ID', '订单状态', '是否删除', '收货人', '收货联系电话', '收货地址','门店名称']
        const filterVal = ['id', 'orderSn', 'userId', 'orderStatus', 'isDelete', 'consignee', 'mobile', 'address','regionName']
