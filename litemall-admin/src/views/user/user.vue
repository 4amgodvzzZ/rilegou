<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="所属门店" prop="regionName"/>
      ...
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="用户等级" prop="userLevel">
          <el-select v-model="dataForm.userLevel">
            ...
            <el-option :value="1" label="社区推广员"/>
            <el-option :value="2" label="商城管理员用户"/>
          </el-select>
        </el-form-item>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['nickname', 'mobile', 'gender', 'birthday', 'status','regionName']
