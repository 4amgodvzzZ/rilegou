  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100" label="名称" prop="name"/>
	    ...
	    <el-table-column align="center" min-width="100" label="所属区域" prop="regionId">
      ...
      <el-table-column align="center" label="进货价格" prop="providePrice"/>
      ...
      <el-table-column align="center" label="操作" width="300" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <!-- <el-button v-show="loginuserregid(scope.row.regionId)" type="primary" size="mini" @click="handleUpdate(scope.row)">编辑</el-button> -->
          <el-button  type="primary" size="mini" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button  type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
		      <!-- <el-button v-show="!loginuserregid(scope.row.regionId)" type="primary" size="mini" @click="handleCopy(scope.row)">复制</el-button> -->
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listGoods, deleteGoods,copyGoods } from '@/api/goods'
...
export default {
  ...
  methods: {
    loginuserregid(regionId) {
      if (regionId == this.$store.getters.regionid){
        return true
      }else{
        return false
      }
    ...
    getRegion(regionId){
      return (this.formatRegion(regionId))
    },
    getList() {
