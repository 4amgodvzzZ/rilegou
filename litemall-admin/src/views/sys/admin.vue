<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="提货地址" prop="address"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item align="center" label="手机号" prop="phone">
          <el-input v-model="dataForm.phone"/>
        </el-form-item>
        <el-form-item align="center" label="提货地址" prop="address">
      ...
      <!-- <div id="atlas"></div> 引入的腾讯地图 不能显示 暂时不知道原因-->
...
export default {
  ...
  methods: {
    ...
    //       //这里经纬度代理表进入地图显示的中心区域
    //       center: new qq.maps.LatLng(22.535885, 113.952514),
    //       zoom: 13
    //     });
    //     //绑定单击事件添加参数
