...
public class WxOrderController {
    ...
    public Object agentlist(@LoginUser Integer userId,
                            @RequestParam String orderdate,
                            @RequestParam(defaultValue = "0") Integer saleduserid,
                            @RequestParam(defaultValue = "0") Integer showType,
                           @RequestParam(defaultValue = "1") Integer page,
                           @RequestParam(defaultValue = "10") Integer size) {

        return wxOrderService.agentlist(userId,saleduserid,orderdate,showType, page, size);
    }
    ...
    public Object detail(@NotNull Integer orderId) {
        return wxOrderService.detailshare(orderId);
    }
