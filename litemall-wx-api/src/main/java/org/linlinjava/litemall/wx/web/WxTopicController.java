...
public class WxTopicController {
    ...
    public Object list(@RequestParam(defaultValue = "1") Integer page,
                       ...
                       @NotNull Integer parentregionid,
                       @Sort @RequestParam(defaultValue = "add_time") String sort,
                       @Order @RequestParam(defaultValue = "desc") String order) {
        List<LitemallTopic> topicList = topicService.queryList(page, size, sort, order,parentregionid);
    ...
    public Object related(@NotNull Integer id,@NotNull Integer parentregionid) {
        List<LitemallTopic> topicRelatedList = topicService.queryRelatedList(id,parentregionid, 0, 4);
