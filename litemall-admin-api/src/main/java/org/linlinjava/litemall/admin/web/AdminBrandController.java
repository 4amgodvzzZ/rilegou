...
public class AdminBrandController {
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "品牌管理"}, button="查询")
    @GetMapping("/list")
    public Object list(String id, String name,
        ...
        List<LitemallBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order,regionid);
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "品牌管理"}, button="添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "品牌管理"}, button="详情")
    @GetMapping("/read")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "品牌管理"}, button="编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "品牌管理"}, button="删除")
    @PostMapping("/delete")
