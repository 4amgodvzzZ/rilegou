...
public class AdminIssueController {
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "通用问题"}, button="查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "通用问题"}, button="添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "通用问题"}, button="编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "通用问题"}, button="删除")
    @PostMapping("/delete")
