...
public class AdminUserController {
    ...
    public Object list(String username, String mobile,
        ...
        List<LitemallUser> newUserList = new ArrayList<>();
        for (LitemallUser litemallUser:userList) {
            LitemallRegion litemallRegion = litemallRegionService.findById(litemallUser.getRegionId());
            String regionName = litemallRegion.getName();
            litemallUser.setRegionName(regionName);
            newUserList.add(litemallUser);
        }

        long total = PageInfo.of(userList).getTotal();
        Map<String, Object> data = new HashMap<>();
        data.put("total", total);
        data.put("items", newUserList);
    ...
    private Object validate(LitemallUser user) {
        ...
        /*if (!RegexUtil.isUsername(nickname)) {
