...
public class AdminGoodsService {
    ...
    public Object list(String goodsSn, String name,
        ...
        List<LitemallGoods> goodsList = goodsService.querySelective(goodsSn, name, page, limit, sort, order,regionid);
   ...
   /* @Transactional
    public Object copy(LitemallGoods goods) {
        ...
        goodsService.copyById(goods);
        specificationService.copyByGid(goods.getId(),oldgid);
        attributeService.copyByGid(goods.getId(),oldgid);
        productService.copyByGid(goods.getId(),oldgid);
        return ResponseUtil.ok();
    }*/
    ...
    public Object create(GoodsAllinone goodsAllinone) {
        ...
        LitemallGoods goods = goodsAllinone.getGoods();
        //将当前上商品的管理员的regionid存入新增的goods 中
        goods.setRegionId(admin.getRegionId());
        LitemallGoodsAttribute[] attributes = goodsAllinone.getAttributes();
        LitemallGoodsSpecification[] specifications = goodsAllinone.getSpecifications();
        LitemallGoodsProduct[] products = goodsAllinone.getProducts();
    ...
    public Object list2() {
        ...
        // 管理员设置“所属品牌商”
        List<LitemallBrand> list = brandService.all(regionid);
