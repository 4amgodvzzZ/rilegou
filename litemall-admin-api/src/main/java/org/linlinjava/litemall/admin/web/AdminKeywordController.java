...
public class AdminKeywordController {
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "关键词"}, button="查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "关键词"}, button="添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "关键词"}, button="详情")
    @GetMapping("/read")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "关键词"}, button="编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu={"销售管理" , "关键词"}, button="删除")
    @PostMapping("/delete")
