...
public class LitemallGrouponRulesService {
     ...
     * @return
     */
    public List<Map<String, Object>> queryList(int offset, int limit,int regionid) {
        return queryList(offset, limit, "add_time", "desc",regionid);
    }

    public List<Map<String, Object>> queryList(int offset, int limit, String sort, String order,int regionid) {
        LitemallGrouponRulesExample example = new LitemallGrouponRulesExample();
     ...
     * @return
     */
    public List<LitemallGrouponRules> querySelective(String goodsId, Integer page, Integer size, String sort, String order,Integer regionId) {
        LitemallGrouponRulesExample example = new LitemallGrouponRulesExample();
        example.setOrderByClause(sort + " " + order);
