...
public class LitemallOrderGoods {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LitemallOrderGoods)) return false;
        ...
        if (getGoodsName() != null ? !getGoodsName().equals(that.getGoodsName()) : that.getGoodsName() != null)
            return false;
        if (getGoodsSn() != null ? !getGoodsSn().equals(that.getGoodsSn()) : that.getGoodsSn() != null) return false;
        ...
        if (!Arrays.equals(getSpecifications(), that.getSpecifications())) return false;
        if (getPicUrl() != null ? !getPicUrl().equals(that.getPicUrl()) : that.getPicUrl() != null) return false;
