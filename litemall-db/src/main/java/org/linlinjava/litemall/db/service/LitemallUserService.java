...
public class LitemallUserService {
    ...
    public LitemallUser findOrderBuyUsersById(Integer userId) {
        return userMapper.selectOrderBuyUsersByPrimaryKey(userId);
    }

    public int countByRegionId(Integer regionId) {
        LitemallUserExample example = new LitemallUserExample();
        example.or().andRegionIdEqualTo(regionId).andDeletedEqualTo(false);
