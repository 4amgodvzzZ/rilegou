...
public class LitemallTopicService {
    ...
    public List<LitemallTopic> queryList(int offset, int limit,int parentregionid) {
        return queryList(offset, limit, "add_time", "desc",parentregionid);
    }

    public List<LitemallTopic> queryList(int offset, int limit, String sort, String order,int parentregionid) {
    ...
    public List<LitemallTopic> queryRelatedList(Integer id, int offset, int limit,int parentregionid) {
        LitemallTopicExample example = new LitemallTopicExample();
        example.or().andIdEqualTo(id).andDeletedEqualTo(false);
    ...
    public List<LitemallTopic> querySelective(String title, String subtitle, Integer page, Integer limit, String sort, String order,Integer regionid) {
        LitemallTopicExample example = new LitemallTopicExample();
