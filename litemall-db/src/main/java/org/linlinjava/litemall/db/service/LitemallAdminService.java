...
public class LitemallAdminService {
    private final Column[] result = new Column[]{Column.id, Column.username, Column.avatar, Column.regionId,Column.phone,Column.roleIds,Column.address,Column.pRegId};
    @Resource
...
//    public List<LitemallAdmin> getList() {
//        return adminMapper.selectAdminList();
//    }
//
//    public LitemallAdmin findAdminByRegionId(Integer regionid) {
//        return adminMapper.selectByRegionId(regionid);
//    }
//
//    public LitemallAdmin findAdminByUserId(Integer userid) {
//        return adminMapper.selectByUserId(userid);
//    }

    public LitemallAdmin querySelectiveLitemall(Integer regionId,Integer userId) {
        LitemallAdminExample example = new LitemallAdminExample();
        LitemallAdminExample.Criteria criteria = example.createCriteria();
        criteria.andDeletedEqualTo(false);
        ...
        return adminMapper.selectOneByExampleSelective(example, result);
    }

    public List<LitemallAdmin> findAdminList() {
        LitemallAdminExample example = new LitemallAdminExample();
        example.or().andDeletedEqualTo(false).andRoleIdsEqualTo(new Integer[]{3});
        return adminMapper.selectByExample(example);
    }
}
